...
My research interests are broadly in statistical learning theory and algorithm design. Some specific areas of interest include: online learning theory, bandits, differential privacy, adversarial robustness, and algorithms with predictions. Currently, I am interested in bridging learning theory and generative machine learning with applications to Transformers and Large Language Models (LLMs). I am also working on empirical research aimed at understanding the abilities and limitations of Transformers and other modern sequence-to-sequence models (see [<b>Projects</b>](#Projects)). 
