...
My research interests broadly lie in statistical learning theory and algorithm design. Some specific areas of interest include: online learning, bandits, differential privacy, adversarial robustness, and algorithms with predictions. More recently, I am interested in bridging the gap between learning theory and generative machine learning. Finally, I am also working on empirical research aimed at understanding the limitations and improving the abilities of Transformers and other modern sequence-to-sequence models (see <b>Projects</b> below). 
