...
My research interests lie in the <strong>Foundations of Machine Learning and Generative AI</strong>. In the past, I worked on online learning, adversarial robustness, and beyond-worst-case analysis for learning algorithms. Currently, I am interested in the safety of <strong>large language models</strong>. In particular, I work on  <strong>test-time scaling</strong>, <strong>alignment</strong>, <strong>differential privacy</strong>, and <strong>synthetic data generation</strong>.
</p>
